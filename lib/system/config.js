...
const { Aemt, Dika } = require('./Api');
const env = require('./../../config.json');
global.Api = {
	aemt: new Aemt(),
	dika: new Dika(),
};
global.header = `© miyu-bot v${require('package.json').version} (Beta)`;
global.footer = '> Simple whatsapp bot by gopret ッ';
global.status = Object.freeze({
	tryAgain: Func.Styles('Server is busy! please try again later.'),
